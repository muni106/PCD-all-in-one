...
public class PixelArtMain {
    ...
    private static void sendGrid() {

    }

    private static void handleIncomingMessage(String message, BrushManager brushManager, PixelGrid grid, PixelGridView view, Channel channel) {
